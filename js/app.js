...
document.addEventListener('click', function(e) {
  ...
  const fnMap = {
    ...
    openDocumentFile: (typeof openDocumentFile === 'function') ? openDocumentFile : null,
    deleteDocument: (typeof deleteDocument === 'function') ? deleteDocument : null,
    reviewDocument: (typeof reviewDocument === 'function') ? reviewDocument : null,
    reviewReport: (typeof reviewReport === 'function') ? reviewReport : null,
    deleteReport: (typeof deleteReport === 'function') ? deleteReport : null,
    toggleActivity: (typeof toggleActivity === 'function') ? toggleActivity : null,
    toggleOfficeItem: (typeof toggleOfficeItem === 'function') ? toggleOfficeItem : null,
    deleteMeeting: (typeof deleteMeeting === 'function') ? deleteMeeting : null,
    deleteSchool: (typeof deleteSchool === 'function') ? deleteSchool : null,
    editUser: (typeof editUser === 'function') ? editUser : null,
    deleteUser: (typeof deleteUser === 'function') ? deleteUser : null
  };
  const fn = fnMap[action];
  if (typeof fn === 'function') {
    e.preventDefault();
    if (action === 'reviewDocument' || action === 'reviewReport') fn(id, status);
    else fn(id);
  }
});
...
function showSection(id) {
  ...
  if (id === 'officeSection' && typeof renderOfficeSection === 'function') renderOfficeSection();
  if (id === 'observerSection')  {
  ...
  if (id === 'usersSection' && typeof renderPendingUsers === 'function') renderPendingUsers();
